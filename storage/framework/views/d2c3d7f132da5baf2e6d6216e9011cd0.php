...
unset($__errorArgs, $__bag); ?>"
                            type="text" name="firstName" id="firstName" value="<?php echo e(old('firstName', $employee->firstname)); ?>" placeholder="Enter First Name">

                            <?php if($errors->get('firstName')): ?>
                                <?php $__currentLoopData = $errors->get('firstName'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>" type="text" name="lastName" id="lastName" value="<?php echo e(old('lastName', $employee->lastname)); ?>" placeholder="Enter Last Name">
...
unset($__errorArgs, $__bag); ?>" type="text" name="email" id="email" value="<?php echo e(old('email', $employee->email)); ?>" placeholder="Enter Email">
...
unset($__errorArgs, $__bag); ?>" type="text" name="age" id="age" value="<?php echo e(old('age', $employee->age)); ?>" placeholder="Enter Age">
                            <?php if($errors->get('age')): ?>
                                <?php $__currentLoopData = $errors->get('age'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="invalid-feedback">
                                        <?php echo e($error); ?>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <select name="position" id="position" class="form-select">
                            <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($position->id); ?>" <?php echo e(old('position',$employee->position_id) == $position->id ? 'selected' : ''); ?>><?php echo e($position->code.' - '.$position->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
<?php /**PATH D:\----- 1. Kuliah\2. Bahan - bahan Kuliah\✨ SEMESTER 4\PEMROGRAMAN FRAMEWORK - IS-04-04\Pertemuan 6\modul-5\resources\views/employee/edit.blade.php ENDPATH**/ ?>