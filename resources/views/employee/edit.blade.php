                ...
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            type="text" name="firstName" id="firstName" value="{{ old('firstName', $employee->firstname) }}" placeholder="Enter First Name">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control @error('email') is-invalid @enderror" type="text" name="email" id="email" value="{{ old('email', $employee->email) }}" placeholder="Enter Email">
                            @if ($errors->get('email'))
